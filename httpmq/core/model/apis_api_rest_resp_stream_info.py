...
class ApisAPIRestRespStreamInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "config": (ApisAPIRestRespStreamConfig,),  # noqa: E501
            "created": (str,),  # noqa: E501
            "state": (ApisAPIRestRespStreamState,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config, created, state, *args, **kwargs):  # noqa: E501
        """ApisAPIRestRespStreamInfo - a model defined in OpenAPI

        Args:
            config (ApisAPIRestRespStreamConfig):
            created (str): Created is the stream creation timestamp
    ...
    @convert_js_args_to_python_args
    def __init__(self, config, created, state, *args, **kwargs):  # noqa: E501
        """ApisAPIRestRespStreamInfo - a model defined in OpenAPI
